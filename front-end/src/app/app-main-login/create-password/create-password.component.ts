...
export class CreatePasswordComponent implements OnInit {
  ...
  public toggleAccordion($event: NgbPanelChangeEvent, acc: any, accordionType: string) {
  ...
  private initForm() {
    ...
    this.form = this._fb.group(
      {
        password: new FormControl(null, [Validators.required, Validators.pattern(new RegExp(passwordRegex))]),
  ...
  public submit() {
    if (this.landingFrom === 'resetPassword') {
      ...
      this._manageUserService.createPassword(this.form.value.password).subscribe((resp: any) => {
  ...
  private resetPassword() {
    this._resetPassword.createPassword(this.form.value.password).subscribe((res: any) => {
