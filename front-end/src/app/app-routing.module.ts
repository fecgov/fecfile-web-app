...
const routes: Routes = [
    ...
    //   children: [
    //     { path: 'committee', loadChildren: () => import('./login/login.module').then((m) => m.LoginModule) },
    //   ]
    // },
  {
    path: 'login',
    ...
    pathMatch: 'full',
    children: [
         { path: 'committee',component: LoginComponent ,data: {
  ...
  },
  {
    ...
    pathMatch: 'full',
    children: [{ path: '', component: UpdateCurrentUserComponent, resolve: { sidebar: SidebarStateResolver } ,data: {
      showCommitteeBanner: false,
      showHeader: false,
      showUpperFooter: false,
    }}],
  },
  {
    ...
    pathMatch: 'full',
    children: [{ path: '', component: SelectCommitteeComponent, resolve: { sidebar: SidebarStateResolver } ,data: {
      showHeader: false,
      showCommitteeBanner: false,
