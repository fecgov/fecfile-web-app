...
import { ValidateUtils } from './schema.validators';
...
describe('ValidateUtils', () => {
  it('#formValidator should validate properties correctly', () => {
    ...
    let validator: ValidatorFn = ValidateUtils.jsonSchemaValidator('telephone', formValidatorForm, formValidatorSchema);
    ...
    validator = ValidateUtils.jsonSchemaValidator('candidate_state', formValidatorForm, formValidatorSchema);
    ...
    validator = ValidateUtils.jsonSchemaValidator('last_name', formValidatorForm, formValidatorSchema);
  ...
  it('#formValidator should validate boolean properties correctly', () => {
    ...
    const formValidatorForm = fb.group(ValidateUtils.getFormGroupFields(ValidateUtils.getSchemaProperties(f3xSchema)));
    formValidatorForm.patchValue({
      change_of_address: 'A',
    });

    let validator: ValidatorFn = ValidateUtils.jsonSchemaValidator(
      'change_of_address',
      formValidatorForm,
      formValidatorSchema,
    );
    ...
    validator = ValidateUtils.jsonSchemaValidator('change_of_address', formValidatorForm, formValidatorSchema);
  ...
  it('#formValidator should validate min/max numeric properties correctly', () => {
    ...
    validator = ValidateUtils.jsonSchemaValidator('L6a_cash_on_hand_jan_1_ytd', formValidatorForm, formValidatorSchema);
