...
export class TableService {
  ...
  public getSortClass(colName: string, currentSortedColumn: string, sortableColumns: SortableColumnModel[]): string {
    const col: SortableColumnModel | undefined = this.getColumnByName(currentSortedColumn, sortableColumns);
    let sortCol = '';
   ...
   */
  public getColumnByName(columnName: string, sortableColumns: SortableColumnModel[]): SortableColumnModel | undefined {
    for (const col of sortableColumns) {
