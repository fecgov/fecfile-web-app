...
import { TransactionGroupL } from './transaction-group-l.model';

describe('TransactionGroupL', () => {
  let component: TransactionGroupL;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [],
      providers: [TransactionGroupL],
    });

    component = TestBed.inject(TransactionGroupL);
  });
