...
export enum ScheduleATransactionTypes {
  ...
  UNREGISTERED_ORGANIZATION_RECOUNT_RECEIPT = 'UNREGISTERED_ORGANIZATION_RECOUNT_RECEIPT',
...
export const ScheduleATransactionTypeLabels: LabelList = [
  ...
  [ScheduleATransactionTypes.UNREGISTERED_ORGANIZATION_RECOUNT_RECEIPT, 'Unregistered Organization Recount Receipt'],
