...
export enum ScheduleATransactionTypes {
  ...
  EARMARK_RECEIPT_FOR_RECOUNT_ACCOUNT_CONTRIBUTION = 'EARMARK_RECEIPT_FOR_RECOUNT_ACCOUNT_CONTRIBUTION',
  EARMARK_RECEIPT_FOR_CONVENTION_ACCOUNT_CONTRIBUTION = 'EARMARK_RECEIPT_FOR_CONVENTION_ACCOUNT_CONTRIBUTION',
  EARMARK_RECEIPT_FOR_HEADQUARTERS_ACCOUNT_CONTRIBUTION = 'EARMARK_RECEIPT_FOR_HEADQUARTERS_ACCOUNT_CONTRIBUTION',
