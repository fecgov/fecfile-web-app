...
export class REFUND_RECEIPTS_FROM_UNREGISTERED_ORGANIZATION_VOID extends SchBTransactionType {
  ...
  getNewTransaction() {
    return SchBTransaction.fromJSON({
      form_type: 'SB28A',
      transaction_type_identifier: ScheduleBTransactionTypes.REFUND_RECEIPTS_FROM_UNREGISTERED_ORGANIZATION_VOID,
