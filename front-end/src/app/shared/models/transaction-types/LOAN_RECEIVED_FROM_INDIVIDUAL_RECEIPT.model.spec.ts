...
describe('LOAN_RECEIVED_FROM_INDIVIDUAL_RECEIPT', () => {
  ...
  beforeEach(() => {
    transactionType = new LOAN_RECEIVED_FROM_INDIVIDUAL_RECEIPT();
  });
  ...
  it('#factory() should return a SchATransaction', async () => {
    ...
    expect(txn.transaction_type_identifier).toBe(ScheduleATransactionTypes.LOAN_RECEIVED_FROM_INDIVIDUAL_RECEIPT);
  });
