...
export enum ScheduleBTransactionTypes {
  ...
  REFUND_RECEIPTS_FROM_UNREGISTERED_ORGANIZATION = 'REFUND_RECEIPTS_FROM_UNREGISTERED_ORGANIZATION',
  REFUND_RECEIPTS_FROM_UNREGISTERED_ORGANIZATION_VOID = 'REFUND_RECEIPTS_FROM_UNREGISTERED_ORGANIZATION_VOID',
...
export const ScheduleBTransactionTypeLabels: LabelList = [
  ...
  [
    ...
    'Refund of Receipts from Unregistered Organization',
  ],
  [
    ScheduleBTransactionTypes.REFUND_RECEIPTS_FROM_UNREGISTERED_ORGANIZATION_VOID,
    'Refund of Receipts from Unregistered Organization - Void',
  ],
