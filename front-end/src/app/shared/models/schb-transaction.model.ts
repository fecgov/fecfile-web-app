...
export enum ScheduleBTransactionTypes {
  ...
  REFUND_RECEIPT_FROM_UNREGISTERED_ORGANIZATION = 'REFUND_RECEIPT_FROM_UNREGISTERED_ORGANIZATION',
  REFUND_RECEIPT_FROM_UNREGISTERED_ORGANIZATION_VOID = 'REFUND_RECEIPT_FROM_UNREGISTERED_ORGANIZATION_VOID',
...
export const ScheduleBTransactionTypeLabels: LabelList = [
  ...
  [
    ...
    'Refund of Receipt from Unregistered Organization',
  ],
  [
    ScheduleBTransactionTypes.REFUND_RECEIPT_FROM_UNREGISTERED_ORGANIZATION_VOID,
    'Refund of Receipt from Unregistered Organization - Void',
  ],
