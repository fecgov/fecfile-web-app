...
@Component({
  selector: 'app-designated-or-subordinate-input',
  templateUrl: './designated-or-subordinate-input.component.html',
  imports: [ReactiveFormsModule, Select, ErrorMessagesComponent, InputText],
})
export class DesignatedOrSubordinateInputComponent extends BaseInputComponent implements OnInit, AfterViewInit {
  private readonly store = inject(Store);

  designatedOrSubordinateOptions = LabelUtils.getPrimeOptions([
    ['', 'Neither'],
    ['Y', 'Designating committee'],
    ['N', 'Subordinate committee'],
  ]);
  ...
  get designatedOrSubordinate(): string {
