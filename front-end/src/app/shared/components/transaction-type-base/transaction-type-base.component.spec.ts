...
describe('TransactionTypeBaseComponent', () => {
  ...
  it('#onContactLookupSelect INDIVIDUAL should set fields', () => {
    ...
    const employerFormControlValue =
      component.form.get('contributor_employer')?.value;
    const occupationFormControlValue =
      component.form.get('contributor_occupation')?.value;
    const street1FormControlValue =
      component.form.get('contributor_street_1')?.value;
    const street2FormControlValue =
      component.form.get('contributor_street_2')?.value;
    const cityFormControlValue =
      component.form.get('contributor_city')?.value;
    const stateFormControlValue =
      component.form.get('contributor_state')?.value;
    const zipFormControlValue =
      component.form.get('contributor_zip')?.value;
