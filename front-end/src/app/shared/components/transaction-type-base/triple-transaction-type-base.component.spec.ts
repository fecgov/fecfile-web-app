...
} from 'app/reports/transactions/triple-transaction-detail/triple-transaction-detail.component';
...
describe('TripleTransactionTypeBaseComponent', () => {
  ...
  describe('updateFormWithPrimaryContact', () => {
    it('should run the super version and then update data if ', () => {
      ...
      component.transaction.contact_1 = testContact;
      expect(component.childTransaction_2?.transactionType?.getUseParentContact(component.childTransaction_2)).toBeTruthy();
  ...
  describe('childUpdateFormWithPrimaryContact_2', () => {
    it('should run the super version and then update data if ', () => {
      ...
      expect(spy).toHaveBeenCalledWith(selectItem, component.childForm_2, component.childTransaction_2, component.childContactIdMap_2['contact_1'])
    });
  });
  ...
  describe('childUpdateFormWithCandidateContact_2', () => {
    it('should run the super version and then update data if ', () => {
      ...
      expect(spy).toHaveBeenCalledWith(selectItem, component.childForm_2, component.childTransaction_2, component.childContactIdMap_2['contact_2'])
    });
  });
