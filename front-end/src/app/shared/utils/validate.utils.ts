...
export class ValidateUtils {
   ...
   */
  static getFormValues(form: FormGroup, jsonSchema?: JsonSchema,
    propertiesSubset: string[] = []) {
   ...
   */
  static addJsonSchemaValidators(form: FormGroup,
    jsonSchema: JsonSchema, clearExistingValidators: boolean,
    ...
    for (const key in form.controls) {
      ...
      form.get(key)?.addValidators(
        ValidateUtils.jsonSchemaValidator(key, form,
          jsonSchema, transaction));
    }
