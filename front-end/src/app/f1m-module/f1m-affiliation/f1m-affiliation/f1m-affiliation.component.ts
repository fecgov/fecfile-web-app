...
export class F1mAffiliationComponent implements OnInit, OnDestroy {
  ...
  public initForm() {
    this.form = this._fb.group({
      affiliation_date: new FormControl({ value: null, disabled: this.disableEdit }, [
        Validators.required,
        Validators.maxLength(100),
      ]),
      committee_id: new FormControl({ value: null, disabled: this.disableEdit }, [
        Validators.required,
        Validators.maxLength(9),
      ]),
      committee_name: new FormControl({ value: null, disabled: this.disableEdit }, [
        Validators.required,
