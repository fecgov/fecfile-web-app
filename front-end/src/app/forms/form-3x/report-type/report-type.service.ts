 ...
 */
  ...
  getAllReportTypes(formType: string) {
    ...
    let httpOptions = new HttpHeaders();
    return this._http.get(mockFile, {
      headers: httpOptions,
    });
  }
      ...
      if (formReportType.election_date !== null) {
        if (typeof formReportType.election_date === 'string') {
          if (formReportType.election_date.length >= 1) {
            formData.append(
              'date_of_election',
              this._datePipe.transform(formReportType.election_date, 'MM/dd/yyyy') ?? ''
            );
          }
        }
      }
    ...
    if (!editMode) {
      ...
      return this._http
        ...
        .pipe(
          map((res: any) => {
            if (res) {
              if (localStorage.getItem(`form_${formType}_report_type`) ?? false) {
                const reportObj: form3xReportTypeDetails = JSON.parse(
                  window.localStorage.getItem(`form_${formType}_report_type`) ?? ''
                );
                if (res['reportid']) {
  ...
  saveAdditionalEmails(saveObj: any, scheduleAction: ScheduleActions): Observable<any> {
    ...
    if (scheduleAction === ScheduleActions.add) {
      ...
      return this._http.put(`${environment.apiUrl}${url}`, formData, {
        headers: httpOptions,
      });
    }
    return of(null);
  ...
  public signandSaveSubmitReport(
    formType: string,
    access_type: string,
    submitterName: string = '',
    form: any = null,
    emailsOnFileArray: string[] = []
  ): Observable<any> {
    let token: string = JSON.parse(this._cookieService.get('user'));
    let httpOptions = new HttpHeaders();
    ...
    if (access_type === 'Saved') {
      ...
      return this._http
        ...
        .pipe(
          ...
          // catchError((error) => this.handleError(error)) NG-UPGRADE-ISSUE
        );
      // );
    }
    return of(null);
  ...
  private handleError(error: any) {
    ...
    this._dialogService
      .confirm(content, ConfirmModalComponent, 'Error', false, ModalHeaderClassEnum.errorHeader, new Map(), 'OK')
      .then((res) => {
        console.log(res);
      });
    return null;
  ...
  public submitForm(formType: string, callFrom: string): Observable<any> {
    ...
    if (form3xReportType !== null) {
      ...
      if (form3xReportType.hasOwnProperty('cvgStartDate')) {
        formData.append(
          'coverageStartDate',
          this._datePipe.transform(form3xReportType.cvgStartDate, 'MM/dd/yyyy') ?? ''
        );
      } else if (form3xReportType.hasOwnProperty('cvgstartdate')) {
        formData.append(
          'coverageStartDate',
  ...
  public printPreview(accessFrom: string, formType: string, transactions?: string, reportId?: string): void {
    ...
    if (typeof transactions === 'undefined') {
      this.prepare_json_builders_data(formType, undefined, reportId).subscribe(
        (res) => {
          if (res) {
            if (res['Response'] === 'Success') {
              this.printPreviewPdf(formType, 'PrintPreviewPDF', undefined, reportId).subscribe(
                (res) => {
                  if (res) {
      ...
      this.prepare_json_builders_data(formType, transactions, reportId).subscribe(
        (res) => {
          if (res) {
            if (res['Response'] === 'Success') {
              this.printPreviewPdf(formType, 'PrintPreviewPDF', transactions, reportId).subscribe(
                (res) => {
                  if (res) {
                    if (res.hasOwnProperty('results')) {
                      if (res['results.pdf_url'] !== null) {
    ...
    report_type: [
      {
        ...
        report_type_info:
          'In an election year/non-election year covers activity from January 1 thru January 31 and due on the 20th of February.',
      ...
      },
      {
        ...
        report_type_info:
          'In an election year/non-election year covers activity from February 1 thru February 28 and due on the 20th of March.',
        regular_special_report_ind: 'R',
        default_disp_ind: 'N',
      ...
      },
      {
        ...
        report_type_info:
          'In an election year/non-election year covers activity from March 1 thru March 31 and due on the 20th of April.',
        regular_special_report_ind: 'R',
        default_disp_ind: 'N',
      ...
      },
      {
        ...
        report_type_info:
          'In an election year/non-election year covers activity from April 1 thru April 30 and due on the 20th of May.',
        regular_special_report_ind: 'R',
        default_disp_ind: 'N',
      ...
      },
      {
        ...
        report_type_info:
          'In an election year/non-election year covers activity from May 1 thru May 31 and due on the 20th of June.',
        regular_special_report_ind: 'R',
        default_disp_ind: 'N',
      ...
      },
      {
        ...
        report_type_info:
          'In an election year/non-election year covers activity from July 1 thru July 31 and due on the 20th of August.',
        regular_special_report_ind: 'R',
        default_disp_ind: 'N',
      ...
      },
      {
        ...
        report_type_info:
          'In an election year/non-election year covers activity from August 1 thru August 31 and due on the 20th of September.',
        regular_special_report_ind: 'R',
        default_disp_ind: 'N',
      ...
      },
      {
        ...
        report_type_info:
          'In an election year/non-election year covers activity from September 1 thru September 30 and due on the 20th of October.',
        regular_special_report_ind: 'R',
        default_disp_ind: 'N',
      ...
      },
      {
        ...
        report_type_info:
          'Due 12 days before the election, covers activity from the close of books of the previous report filed through the 20th day before the general. A committee must file pre-primary reports only if the committee has made previously undisclosed contributions or  (...)',
      ...
      },
      {
        ...
        report_type_info:
          'In an election year covers activity that occurred after the closing date of the last report through the 20th day after the general election.  The report is due 30 days after the election.',
        regular_special_report_ind: 'S',
        default_disp_ind: 'N',
        cvg_start_date: 'EFO',
        cvg_end_date: 'EFO',
  ...
  private monthlyNonElectionJSON = {
    report_type: [
      ...
      },
      {
        ...
        report_type_info:
          'In an election year/non-election year covers activity from October 1 thru October 31 and due on the 20th of November.',
        regular_special_report_ind: 'R',
        default_disp_ind: 'N',
      ...
      },
      {
        ...
        report_type_info:
          'In an election year/non-election year covers activity from November 1 thru November 30 and due on the 20th of December.',
        regular_special_report_ind: 'R',
        default_disp_ind: 'N',
    ...
    report_type: [
      {
        ...
        report_type_info:
          'In an election year/non-election year covers activity from January 1 thru March 31 and due on the 20th of April.',
        regular_special_report_ind: 'R',
        default_disp_ind: 'N',
        cvg_start_date: '2020-01-01',
        cvg_end_date: '2020-03-31',
      ...
      },
      {
        ...
        report_type_info:
          'In an election year/non-election year covers activity from Jul 1 thru September 30 and due on the 20th of October.',
        regular_special_report_ind: 'R',
        default_disp_ind: 'N',
        cvg_start_date: '2020-07-01',
        cvg_end_date: '2020-09-30',
