        ...
        if (this.frm.valid) {
          ...
          if (this.step === 'step_5') {
            this._router.navigate(['/forms/form/99'], {
              queryParams: { step: this.step, fec_id: this.fec_id, edit: this.editMode, refresh: this.editMode },
            });
          } else {
            this._router.navigate(['/forms/form/99'], {
              queryParams: { step: this.step, reportId: this.reportId, edit: this.editMode, refresh: this.editMode },
            });
          }
