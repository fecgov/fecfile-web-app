...
export class TypeComponent implements OnInit, OnDestroy {
  ...
  @ViewChild('mswCollapse') mswCollapse!: any;
  ...
  private _form99Details!: form99 | null;
  ...
  ngOnInit(): void {
    ...
    this.routerEventsSubscription = this._router.events.subscribe((e) => {
  ...
  */
  public optionsListClick(type: any): void {
