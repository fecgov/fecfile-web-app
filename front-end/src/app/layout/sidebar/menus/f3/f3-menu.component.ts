...
export class F3MenuComponent extends AbstractMenuComponent {
  ...
  readonly coverageFromDateSignal = computed(() => (this.activeReport() as Form3).coverage_from_date);
  readonly coverageThroughDateSignal = computed(() => (this.activeReport() as Form3).coverage_through_date);
