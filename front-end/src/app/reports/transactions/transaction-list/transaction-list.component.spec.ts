...
describe('TransactionListComponent', () => {
  ...
  it('should navigate to create receipt', () => {
    ...
    component.onTableActionClick(component.tableActions[0], { id: '999' } as F3xReport);
  ...
  it('should navigate to create disbursement', () => {
    const navigateSpy = spyOn(router, 'navigateByUrl');
    component.onTableActionClick(component.tableActions[1], { id: '999' } as F3xReport);
  ...
  it('should navigate to create loans & debts', () => {
    const navigateSpy = spyOn(router, 'navigateByUrl');
    component.onTableActionClick(component.tableActions[2], { id: '999' } as F3xReport);
  ...
  it('should navigate to create other transactions', () => {
    const navigateSpy = spyOn(router, 'navigateByUrl');
    component.onTableActionClick(component.tableActions[3], { id: '999' } as F3xReport);
