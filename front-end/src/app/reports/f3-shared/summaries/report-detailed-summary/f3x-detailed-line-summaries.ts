...
export function receiptLines(report: Form3X): LineSummary[] {
  return [
    {
      lineNumber: '11',
...
export function disbursementLines(report: Form3X): LineSummary[] {
  return [
    {
      lineNumber: '21',
...
export function thirdLines(report: Form3X): LineSummary[] {
  return [
    {
      lineNumber: '33',
      description: `TOTAL CONTRIBUTIONS`,
