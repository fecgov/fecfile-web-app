...
import { TransactionGroupGgComponent } from './transaction-group-gg.component';
import { ConfirmDialogModule } from 'primeng/confirmdialog';

describe('TransactionGroupGgComponent', () => {
  let component: TransactionGroupGgComponent;
  let fixture: ComponentFixture<TransactionGroupGgComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [TransactionGroupGgComponent],
      providers: [MessageService, ConfirmationService, FormBuilder, provideMockStore(testMockStore), FecDatePipe],
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(TransactionGroupGgComponent);
