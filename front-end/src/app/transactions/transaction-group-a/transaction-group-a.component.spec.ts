...
describe('TransactionGroupAComponent', () => {
  ...
  xit('should reset form values when the entity_type changes', () => {
  ...
  xit('#save() should save a new record', () => {
  ...
  xit('#save() should update an existing record', () => {
    if (component.transaction) {
  ...
  xit('#save() should not save an invalid record', () => {
