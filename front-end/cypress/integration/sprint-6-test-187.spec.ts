...
const contact = GenerateContactObject({"contact_type":"Organization"});

describe('QA Test Script #187 (Sprint 6)', () => {
  ...
  function after(){
    cy.get("p-table")
      .find("tr")
      .contains(`${contact["organization_name"]}`) //Finds out contact in the Manage Contacts table
